...
const countDuration = getDurationFromUrl();

function fetchDuration(){
    const API = `https://cms.istad.co/api/ms-movies?populate=*&filters[duration][$gte]=${countDuration}`
    const duration_card = document.getElementById("duration");
    fetch(API)
    .then(res =>{
        return res.json();
    })
